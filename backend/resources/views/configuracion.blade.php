...
<li class="nav-item">
	...
	<div class="col-sm-6">
		<ol class="breadcrumb float-sm-right">
			...
			<li class="breadcrumb-item txt-blue active">Configuración</li>
		</ol>
	</div>
</div>
					</div><!-- /.container-fluid -->
	...
	<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
		<div class="card card-secondary">
			...
			<form id="form_actualiza_datos_local">
				<div class="card-body">
					<label class="col-form-label" for="inputWarning"><i class="fas fa-pencil-alt"></i> Nombre del negocio</label>
					<div class="input-group mb-3">
						<div class="input-group-prepend">
							<span class="input-group-text"><i class="fas fa-award"></i></span>
						</div>
						<input type="text" class="form-control" placeholder="Nombre del local" disabled="disabled" value="Bodega Principal" required="required">
					</div>
					<label class="col-form-label" for="inputWarning"><i class="fas fa-pencil-alt"></i> Dirección del negocio</label>
					<div class="row">
						<div class="col-lg-3 col-md-6 col-xs-12 col-sm-6">
							<div class="input-group">
								...
								<input type="text" class="form-control" placeholder="Nombre del local" disabled="disabled" value="Cuernavaca" required="required">
							</div>
						</div>
						<div class="col-lg-3 col-md-6 col-xs-12 col-sm-6">
							<div class="input-group">
								...
								<input type="text" class="form-control" placeholder="Nombre del local" disabled="disabled" value="Morelos" required="required">
							</div>
						</div>
						<div class="col-lg-4 col-md-6 col-xs-12 col-sm-6">
							<div class="input-group">
								...
								<input type="text" class="form-control" placeholder="Nombre del local" disabled="disabled" value="SATURNO #5" required="required">
							</div>
						</div>
						<div class="col-lg-2 col-md-6 col-xs-12 col-sm-6">
							<div class="input-group">
								...
								<input type="text" class="form-control" placeholder="Nombre del local" disabled="disabled" value="62080" required="required">
							</div>
						</div>
					</div>
					<label class="col-form-label" for="inputWarning"><i class="fas fa-pencil-alt"></i> Datos de contacto</label>
					<div class="row">
						<div class="col-lg-6 col-md-6 col-xs-12 col-sm-6">
							<div class="input-group">
								...
								<input type="email" class="form-control" placeholder="Correo electrónico" name="correo" required="required" value="administrador@fusiond3.mx" required="required">
							</div>
						</div>
						<div class="col-lg-6 col-md-6 col-xs-12 col-sm-6">
							<div class="input-group">
								...
								<input type="number" class="form-control" placeholder="Teléfono" name="telefono" required="required" value="7771002020" required="required">
							</div>
						</div>
					</div>
				</div>
				<div class="card-footer">
					<button type="submit" class="btn btn-primary" id="btn_actualiza_datos_local"><i class="fas fa-save"></i> Guardar</button>
				</div>
			</form>
		</div>
	</div>

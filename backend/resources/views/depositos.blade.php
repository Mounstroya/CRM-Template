...
<head>
    ...
    <ul class="navbar-nav">
      <li class="nav-item">
        <a class="nav-link" data-widget="pushmenu" href="/depositos#" role="button"><i class="fas fa-bars"></i></a>
      </li>
    ...
    <ul class="navbar-nav ml-auto">
        ...
        <a class="nav-link" data-toggle="dropdown" href="/depositos#">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
          ...
          <div id="sugerencia28">
            <a href="/depositos#" class="dropdown-item">
          ...
          <div id="sugerencia2997">
            ...
            <li class="nav-item">
        <a class="nav-link" href="/depositos#" data-toggle="modal" data-target="#updatePasswordModal">
      ...
      .catch(error => {
        ...
        alert('Error al actualizar la contraseña. Verifique la consola para más detalles.');
			...
			<aside class="main-sidebar elevation-4 sidebar-light-warning">
				<!-- Brand Logo -->
				<a href="/depositos#" class="brand-link" style="text-align: center ;">
  ...
  <div class="user-panel mt-3 pb-3 mb-3 d-flex">
    ...
    <div class="info">
      <a href="/depositos#" class="d-block">Administrador</a>
...
<li class="nav-item">
    ...
    <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item txt-blue active">Depósitos</li>
        </ol>
    </div><!-- /.col -->
</div><!-- /.row -->
					</div><!-- /.container-fluid -->
                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div class="card-tools">
                                <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modalAddDeposito">
    ...
    <!-- Modal -->
    <div class="modal fade" id="modalAddDeposito" tabindex="-1" role="dialog" aria-labelledby="modalAddDepositoLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <form action="#" method="POST" enctype="multipart/form-data">
                    <input type="hidden" name="_token" value="{{ csrf_token() }}">                    <div class="modal-header">
                        <h5 class="modal-title" id="modalAddDepositoLabel">Nuevo Depósito</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" id="monto" name="monto" value="0" readonly>
                        </div>
                        <div class="form-group">
                            <label for="fecha">Fecha</label>
                            <input type="date" class="form-control" id="fecha" name="fecha" value="2026-08-12" required>
                        </div>
                        <div class="form-group">
  ...
  Copyright &copy;<script>document.write(new Date().getFullYear());</script> <a href="/depositos#" target="_blank">FD3-ACCESORIOS</a> | Icons <a href="https://iconos8.es/">Icons8</a>
  <div class="float-right d-none d-sm-inline-block">
    ...
    $(document).ready(function() {
        $('#menu_depositos').attr('class', 'nav-link active');

        $('#fecha').on('change', function() {
            var fecha = $(this).val();
            $.ajax({
                url: '/depositos/getMontoByFecha',
                method: 'POST',
                data: {
        ...
        // Bloquear el botón de guardar al enviar el formulario de depósito
        $('#modalAddDeposito form').on('submit', function() {
            var $btn = $(this).find('button[type="submit"]');
            $btn.prop('disabled', true).text('Procesando...');
        });

        // Si el modal se cierra, restaurar el botón
        $('#modalAddDeposito').on('hidden.bs.modal', function () {
            var $btn = $(this).find('button[type="submit"]');

    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="titulo_nota" style="color: green">ABONO DE CRÉDITO</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <form id="formAbonoCredito" method="POST" action="/clientes-store">
                <div class="modal-body">
                    <input type="hidden" name="_token" value="{{ csrf_token() }}">                    
					<div class="text-center">
						<div class="form-group">
							<label for="totalDeuda" style="font-size: 18px;">Total Deuda: </label>
							<p id="totalDeuda" placeholder="totalDeuda" style="font-size: 38px; color:#d91a1a; font-weight:bold"></p>
						</div>
						<hr>
					</div>
					<div class="form-row">
						<div class="form-group col-4">
							...
							<input type="number" name="efectivo" class="form-control" id="efectivo" placeholder="Monto en efectivo">
						</div>
						<div class="form-group col-4">
					...
					<div class="form-row">
						<div class="form-group col-12">
							<img src="data:image/png;base64,">
							<label id="nombreCliente"></label><br>
                            <p style="font-size: 22px;">Saldo pendiente: <span style="color:#1fb778;" id="saldoPendiente"></span></p>
						</div>
					</div>
                </div>
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-primary" id="btnAbonoCredito">Registrar</button>
                </div>
            </form>
        </div>
    </div>
...
<div class="modal fade" id="modalAbonos" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="titulo_nota" style="color: green">Historial de abonos</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
    ...
    <ul class="navbar-nav">
      <li class="nav-item">
        <a class="nav-link" data-widget="pushmenu" href="/creditos#" role="button"><i class="fas fa-bars"></i></a>
      </li>
    ...
    <ul class="navbar-nav ml-auto">
        ...
        <a class="nav-link" data-toggle="dropdown" href="/creditos#">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
          ...
          <div id="sugerencia2997">
            ...
            <li class="nav-item">
        <a class="nav-link" href="/creditos#" data-toggle="modal" data-target="#updatePasswordModal">
      ...
      .catch(error => {
        ...
        alert('Error al actualizar la contraseña. Verifique la consola para más detalles.');
			...
			<aside class="main-sidebar elevation-4 sidebar-light-warning">
				<!-- Brand Logo -->
				<a href="/creditos#" class="brand-link" style="text-align: center ;">
  ...
  <div class="user-panel mt-3 pb-3 mb-3 d-flex">
    ...
    <div class="info">
      <a href="/creditos#" class="d-block">Administrador</a>
...
<div class="row">
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
        <div class="card">
            <div class="card-header">
                <h5 class="card-title" style="font-weight: bold">VENTAS A CRÉDITO POR PAGAR</h5>
  ...
  Copyright &copy;<script>document.write(new Date().getFullYear());</script> <a href="/creditos#" target="_blank">FD3-ACCESORIOS</a> | Icons <a href="https://iconos8.es/">Icons8</a>
  <div class="float-right d-none d-sm-inline-block">
	...
	<script src="/plugins/jquery-mapael/maps/usa_states.min.js"></script-->
		...
		<script src="jspdv/creditos.js"></script>
<script>
    window.userType = "Propietario";
    window.routeGetCreditos = "/credito.getCreditos";
    window.routeCreditoAbonar = "/credito.abonar";
    window.routeTablaAbonos = "/credito.tablaAbonos";
</script>
<script src="js/app-creditos.js%3Fid=ece7587eeb4ac3ac677bebc9f5fae20c"></script>
		<script>

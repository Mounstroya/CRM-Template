...
<head>
	...
	<body class="hold-transition sidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed">
		<div class="modal fade" id="modal_ver_nota" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
	<div class="modal-dialog modal-dialog-centered" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title" id="titulo_nota" style="color: red"></h5>
...
<div class="modal fade" id="modalCancelar" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
	<div class="modal-dialog modal-dialog-centered" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title" id="exampleModalCenterTitle">CANCELACIÓN DE VENTA</h5>
				<button type="button" class="close" data-dismiss="modal" aria-label="Close">
					<span aria-hidden="true">&times;</span>
				</button>
			</div>
			<form id="formCancelarVenta">
				<div class="modal-body">
					<input type="hidden" name="_token" value="{{ csrf_token() }}">					<input type="hidden" id="venta_id" name="venta_id">
					<!--Agrega radiobutton horizontal con opción Efectivo, transferencia-->
					<div class="form-group row">
						<label for="forma_pago" class="col-sm-12 col-form-label" id="tituloDevolucion">TIPO DEVOLUCIÓN</label>
						<div class="col-sm-12">
							<div class="form-check">
								<input class="form-check-input" type="radio" name="forma_pago" id="forma_pago_efectivo" value="efectivo" checked>
								<label class="form-check-label" for="forma_pago_efectivo">
									EFECTIVO
								</label>
							</div>
							<div class="form-check">
								<input class="form-check-input" type="radio" name="forma_pago" id="forma_pago_transferencia" value="transferencia">
								<label class="form-check-label" for="forma_pago_transferencia">
									TRANSFERENCIA
								</label>
							</div>
						</div>
					</div>
					<!--Agrega textarea para agregar el motivo de la cancelación-->
				...
				<div class="modal-footer">
					<button type="button" class="btn btn-secondary" data-dismiss="modal">Cerrar</button>
					<button type="submit" class="btn btn-success" id="btn_submit_cancelar_venta">Continuar</button>
				</div>
			</form>
		</div>
	</div>
...
<div class="modal fade" id="modalVerCancelacion" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
	<div class="modal-dialog modal-dialog-centered" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title" id="exampleModalCenterTitle">INFORME DE CANCELACIÓN</h5>
				<button type="button" class="close" data-dismiss="modal" aria-label="Close">
					<span aria-hidden="true">&times;</span>
				</button>
			</div>
			<div class="modal-body">
				<!--Agrega radiobutton horizontal con opción Efectivo, transferencia-->
				<div class="form-group row">
					<label for="forma_pago" class="col-sm-12 col-form-label" id="tituloDevolucion">Motivo de cancelación</label>
					<div class="col-sm-12">
						<p id="ver_motivo_cancelacion"></p>
					</div>
				</div>
				<div class="form-group row">
					<label for="forma_pago" class="col-sm-12 col-form-label" id="tituloDevolucion">Datos de cancelación</label>
					<div class="col-sm-12">
						<p id="ver_cancelado_por"></p>
						<p id="ver_fecha_cancelacion"></p>
					</div>
				</div>
			</div>
			<div class="modal-footer">
...
<!-- Modal para cancelar producto -->
<div id="modal_cancelacion_producto" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="modalCancelacionProductoLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="modalCancelacionProductoLabel">Cancelar producto</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Cerrar">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
        <form id="form_cancelacion_producto">
          <!-- Campos ocultos para enviar venta y producto -->
          <input type="hidden" id="cancel_sale_id" name="venta_id">
          <input type="hidden" id="cancel_product_id" name="producto_id">
          <div class="form-group">
            <label for="cancel_quantity">Cantidad a cancelar:</label>
            <input type="number" class="form-control" id="cancel_quantity" name="cantidad" min="1">
          </div>
          <!-- Contenedor para mostrar errores -->
          <div class="alert alert-danger d-none" id="cancel_error"></div>
        </form>
      </div>
      <div class="modal-footer">
        <button type="button" id="btn_cancel_product" class="btn btn-danger">Confirmar cancelación</button>
        <button type="button" class="btn btn-secondary" data-dismiss="modal">Cerrar</button>
      </div>
    </div>
  </div>
    ...
    <ul class="navbar-nav">
      <li class="nav-item">
        <a class="nav-link" data-widget="pushmenu" href="/historico#" role="button"><i class="fas fa-bars"></i></a>
      </li>
    ...
    <ul class="navbar-nav ml-auto">
        ...
        <a class="nav-link" data-toggle="dropdown" href="/historico#">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
          ...
          <div id="sugerencia2997">
            ...
            <li class="nav-item">
        <a class="nav-link" href="/historico#" data-toggle="modal" data-target="#updatePasswordModal">
      ...
      .catch(error => {
        ...
        alert('Error al actualizar la contraseña. Verifique la consola para más detalles.');
			...
			<aside class="main-sidebar elevation-4 sidebar-light-warning">
				<!-- Brand Logo -->
				<a href="/historico#" class="brand-link" style="text-align: center ;">
  ...
  <div class="user-panel mt-3 pb-3 mb-3 d-flex">
    ...
    <div class="info">
      <a href="/historico#" class="d-block">Administrador</a>
...
<li class="nav-item">
	...
	<div class="col-sm-6">
		<ol class="breadcrumb float-sm-right">
			<li class="breadcrumb-item"><a href="/historico#">Mi local</a></li>
			<li class="breadcrumb-item txt-blue active">Mis ventas</li>
		</ol>
	</div>
</div>
					</div><!-- /.container-fluid -->
	...
	<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
		<div class="card card-secondary">
			<div class="card-header">
				<h3 class="card-title"><i clas="fa fa-list-ul"></i> Informe de ventas</h3>
			</div>
			<div class="card-body">

				<b style="font-weight: 100;font-size: x-large;color: #0086de;">
					Del <input type="date" class="form-control" style="display: inline;width:160px" id="fecha_inicio" value="{{ now()->format('Y-m-d') }}" onchange="getVentas()">
					al <input type="date" class="form-control" style="display: inline;width:160px" id="fecha_final" value="{{ now()->format('Y-m-d') }}" onchange="getVentas()">
					<select class="form-control" style="display: inline;width:160px" id="asesor" onchange="getVentas()">
					...
					<img id="btn_reporte_excel" style="cursor: pointer" src="data:image/png;base64,">
				</b>
				<br>
				...
				<form id="form_reporte_excel" action="/reporteExcel" method="POST">
					<input type="hidden" name="_token" value="{{ csrf_token() }}">					<input type="hidden" id="excel_fecha_inicio" name="fecha_inicio">
					<input type="hidden" id="excel_fecha_fin" name="fecha_fin">
					<input type="hidden" id="excel_asesor" name="asesor">
				</form>
				<span id="total_vendido" class="badge badge-primary totales"></span>
									<span id="total_utilidad" class="badge badge-success totales"></span>
								<br><br>
				<div class="row">
					<div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
						<canvas style="position: relative; height:40vh; width:100vw" id="myChart"></canvas>
					</div>
					<div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
						<canvas style="position: relative; height:40vh; width:100vw" id="chartVentasByDepartamento"></canvas>
					</div>
					<div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
						<canvas style="position: relative; height:40vh; width:100vw" id="chartVentasByProducto"></canvas>
					</div>
					<div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
						<canvas style="position: relative; height:40vh; width:100vw" id="chartVentasByProductoMenosVendidos"></canvas>
                    </div>
				</div>
				<br><br>
						...
						<thead class="thead-light">
							<tr>
								...
								<th scope="col">TOTAL ABONADO</th>
																	<th scope="col">UTILIDAD</th>
																	<th scope="col">ABONO ENTRE FECHAS</th>
								<!--th scope="col">FECHA ABONO</th-->
							</tr>
						</thead>
						<tbody id="content_tbl_ventas_credito">
						</tbody>
					</table>
				</div>
			</div>
  ...
  Copyright &copy;<script>document.write(new Date().getFullYear());</script> <a href="/historico#" target="_blank">FD3-ACCESORIOS</a> | Icons <a href="https://iconos8.es/">Icons8</a>
...
<script src="jspdv/historico.js"></script>
<script>
	window.userType = "Propietario";
	window.dominio = "fd3-accesorios";
	window.routeGetVentas = "/getVentas";
	window.routeVerNota = "/verNota";
	window.routeVentasCancelar = "/ventas.cancelar";
	window.routeVerCancelacion = "/ventas.verCancelacion";
	window.routeCancelarProducto = "/ventas.cancelarProducto";
</script>
<script src="js/app-ventas.js%3Fid=ef6c7867540fd347e3a6f603451d97f0"></script>
<script>

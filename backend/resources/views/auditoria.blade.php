...
<li class="nav-item">
    ...
    <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item txt-blue active">Auditoría de mercancía</li>
        </ol>
    </div><!-- /.col -->
</div><!-- /.row -->
					</div><!-- /.container-fluid -->
    ...
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
        <div class="card">
            <div class="card-header">
                <h5 class="card-title" style="font-weight: bold">LOCALES A AUDITAR</h5>
                ...
                <div class="row">
                    <div class="col-lg-8 col-sm-12 col-xs-12">
                        ...
                        <div class="table-responsive">
                            ...
                            <table id="tblLocales" class="table table-bordered table-sm table-hover">
                    ...
                    <div class="col-lg-4 col-sm-12 col-xs-12">
                        <form action="#">
                            <!--Crea un formulario donde tenga un select2 con los locales y un select2 con la fecha de auditoria y un boton de buscar-->
                            <div class="row">
                                ...
                                <div class="form-group col-12 col-md-12">
                                    ...
                                    <select name="fecha" id="fecha" class="form-control select2" style="width: 100%;">
                                        
                                    </select>
                                </div>
                                <div class="form-group col-12 col-md-12 text-right">
                                    <a href="/auditoria#" class="btn btn-info" id="btnBuscar"><i class="fa fa-search"></i> Buscar</a>
                                </div>
                                <div class="form-group col-12 col-md-12">
                                    <hr>
                                    <h6><strong>Exportar Todas las Auditorías del Local</strong></h6>
                                    <p class="text-muted" style="font-size: 12px;">Genera un reporte con todas las auditorías realizadas, agrupadas por producto para detectar anomalías.</p>
                                    <button type="button" class="btn btn-success btn-block" id="btnExportarLocalExcel">
                                        <i class="fa fa-file-excel"></i> Exportar Excel Completo
                                    </button>
                                    <button type="button" class="btn btn-danger btn-block" id="btnExportarLocalPDF">
                                        <i class="fa fa-file-pdf"></i> Exportar PDF por Producto
                                    </button>
                                </div>
                            </div>
                        </form>
...
<script>
    window.routeGetLocalesAuditoria = '/autidoria/get-locales-auditoria';
    window.routeNuevaAuditoria = '/autidoria/nueva-auditoria';
    window.routeFechasAuditoriaLocal = '/auditoria/fechas-auditoria-local';
    window.routeReporteLocalExcel = '/auditoria/reporte-local-excel';
    window.routeReporteLocalPDF = '/auditoria/reporte-local-pdf';
</script>
<script src="js/app-auditoria.js%3Fid=683bf3703bd18a0a7f17c2d2f020a599"></script>
		<script>

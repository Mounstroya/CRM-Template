    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="titulo_nota" style="color: green">Nuevo cliente</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <form id="formAddCliente" method="POST" action="/clientes-store">
                    ...
                    <input type="hidden" name="_token" value="{{ csrf_token() }}">                    <div class="row">
                        ...
                        <div class="form-group col-12 col-md-6">
                            ...
                            <select class="form-control" name="nivel" id="nivel">
                                                                                                <option value="1">SUBDISTRIBUIDOR</option>
                                                                <option value="2">PREFERENTE</option>
                                                                <option value="3">POR CAJA</option>
                                                                                            </select>
                        </div>

                                                <div class="form-group col-12 col-md-6">
                            <label for="dias_credito">Días de crédito:</label>
                            <input type="number" name="dias_credito" class="form-control" min="0">
                        </div>
                        <div class="form-group col-12 col-md-6">
                            <label for="limite_credito">Límite de Crédito:</label>
                            <input type="number" name="limite_credito" class="form-control" min="0">
                        </div>
...
<div class="modal fade" id="modal_editar_cliente" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="titulo_nota" style="color: green">Editar cliente</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="form-group col-12 col-md-6">
                            ...
                            <select class="form-control" name="nivel" id="nivelEdit" required>
                                                                <option value="1" >
                                1 - SUBDISTRIBUIDOR
                                </option>
                                                                <option value="2" >
...
<div class="modal fade" id="modalCargaMasiva" tabindex="-1" role="dialog" aria-labelledby="modalCargaMasivaTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modalCargaMasivaTitle" style="color: green">Carga Masiva de Clientes</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <form id="formCargaMasiva" method="POST" action="/clientes/cargaMasiva" enctype="multipart/form-data">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label for="omitir_encabezado">
                            <input type="checkbox" name="omitir_encabezado" value="1" checked> Omitir primera fila (encabezados)
                        </label>
                    </div>
                </div>
                <div class="modal-footer">
    ...
    <ul class="navbar-nav">
      <li class="nav-item">
        <a class="nav-link" data-widget="pushmenu" href="/cartera-de-clientes#" role="button"><i class="fas fa-bars"></i></a>
      </li>
    ...
    <ul class="navbar-nav ml-auto">
        ...
        <a class="nav-link" data-toggle="dropdown" href="/cartera-de-clientes#">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
          ...
          <div id="sugerencia28">
            <a href="/cartera-de-clientes#" class="dropdown-item">
          ...
          <div id="sugerencia2997">
            ...
            <li class="nav-item">
        <a class="nav-link" href="/cartera-de-clientes#" data-toggle="modal" data-target="#updatePasswordModal">
      ...
      .catch(error => {
        ...
        alert('Error al actualizar la contraseña. Verifique la consola para más detalles.');
			...
			<aside class="main-sidebar elevation-4 sidebar-light-warning">
				<!-- Brand Logo -->
				<a href="/cartera-de-clientes#" class="brand-link" style="text-align: center ;">
  ...
  <div class="user-panel mt-3 pb-3 mb-3 d-flex">
    ...
    <div class="info">
      <a href="/cartera-de-clientes#" class="d-block">Administrador</a>
...
<li class="nav-item">
    ...
    <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item txt-blue active">Cartera de clientes</li>
        </ol>
    </div><!-- /.col -->
</div><!-- /.row -->
...
<div class="row mb-2">
    <div class="col-sm-12">
        <input type="text" id="searchCliente" class="form-control" placeholder="Buscar por nombre, apellidos o nivel">
    </div>
...
<div class="row">
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
        <div class="card">
            <div class="card-header">
                ...
                @endif
                <h5 class="card-title" style="font-weight: bold">CARTERA DE CLIENTES</h5>
                <div class="card-tools">
                    <button type="button" class="btn btn-warning btn-tool" style="color: #000; background-color:#ffc107" data-toggle="modal" data-target="#modalAddcliente">Nuevo cliente <i class="fa fa-plus"></i></button>
                                            <button type="button" class="btn btn-info btn-tool" style="color: #fff; background-color:#17a2b8" data-toggle="modal" data-target="#modalCargaMasiva">Carga Masiva <i class="fa fa-upload"></i></button>
                                                                <a href="clientes/exportExcel" class="btn btn-success btn-tool" style="color: #fff; background-color:#28a745">Descargar Excel <i class="fa fa-download"></i></a>
                                    </div>
            </div>
            <div class="card-body">
                <div class="row">
                    <!-- Aquí se mostrará la tabla de clientes -->
                    <div class="table-responsive" id="tablaClientes"></div>
                </div>
            </div>
        </div>
    </div>
  ...
  Copyright &copy;<script>document.write(new Date().getFullYear());</script> <a href="/cartera-de-clientes#" target="_blank">FD3-ACCESORIOS</a> | Icons <a href="https://iconos8.es/">Icons8</a>
  <div class="float-right d-none d-sm-inline-block">
	...
	<script src="/plugins/jquery-mapael/maps/usa_states.min.js"></script-->
		...
		<script>
    window.localId = "1";
    window.niveles = {"1":"SUBDISTRIBUIDOR","2":"PREFERENTE","3":"POR CAJA"};
    window.routeGetCliente = "/getCliente";
    window.routeClientesUpdate = "/clientes.update";
    window.routeClientesTabla = "/clientes.tabla";
</script>
<script src="jspdv/clientes.js"></script>
<script src="js/app-clientes.js%3Fid=a72408a2e9c5a0c98e3c41da85eca411"></script>
<script>
    ...
    document.getElementById('searchCliente').addEventListener('input', function() {
        ...
        let resultCount = 0;
        rows.forEach(row => {
            let nombreCell = row.querySelector('td:nth-child(1)');
            let apellidoPCell = row.querySelector('td:nth-child(2)');
            let apellidoMCell = row.querySelector('td:nth-child(3)');
            let nivelCell = row.querySelector('td:nth-child(4)'); // Asumiendo que el nivel está en la cuarta columna
            
            let nombre = nombreCell ? nombreCell.textContent.toLowerCase() : '';
            let apellidoP = apellidoPCell ? apellidoPCell.textContent.toLowerCase() : '';
            let apellidoM = apellidoMCell ? apellidoMCell.textContent.toLowerCase() : '';
            let nivel = nivelCell ? nivelCell.textContent.toLowerCase() : '';
            
            if (nombre.includes(searchValue) || apellidoP.includes(searchValue) || apellidoM.includes(searchValue) || nivel.includes(searchValue)) {
                row.style.display = '';
                resultCount++;
            } else {
        ...
        document.getElementById('resultCount').textContent = resultCount + ' resultados encontrados';
    });
</script>
		<script>
